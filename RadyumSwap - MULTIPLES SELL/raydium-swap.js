...
var RaydiumSwap = /** @class */ (function () {
    function RaydiumSwap(RPC_URL, WALLET_SECRET_KEY) {
        ...
        try {
            ...
            var secretKey = base58.decode(WALLET_SECRET_KEY);
    ...
    RaydiumSwap.prototype.getSwapTransaction = function (fromToken_1, amount_1, poolKeys_1) {
        return __awaiter(this, arguments, void 0, function (fromToken, amount, poolKeys, useVersionedTransaction, slippage) {
            var poolInfo, swapSide, baseToken, quoteToken, currencyIn, currencyOut, amountIn, slippagePercent, _a, amountOut, minAmountOut, userTokenAccounts, priorityFee, swapTransaction, recentBlockhashForSwap, instructions, versionedTransaction, legacyTransaction;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        poolInfo = _b.sent();
                        swapSide = this.getSwapSide(poolKeys, new web3_js_1.PublicKey(fromToken), spl_token_1.NATIVE_MINT);
