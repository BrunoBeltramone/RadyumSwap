...
function checkAllTokenBalances() {
    return __awaiter(this, void 0, void 0, function () {
        var raydiumSwap, allBalances, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    allBalances = _a.sent();
                    allBalances.forEach(function (_a) {
                        var mint = _a.mint, balance = _a.balance;
                        console.log("Balance of token ".concat(mint, ": ").concat(balance));
                    });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching all token balances:', error_1);
                    return [3 /*break*/, 3];
