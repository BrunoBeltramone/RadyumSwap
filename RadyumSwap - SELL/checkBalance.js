...
function checkTokenBalance() {
    return __awaiter(this, void 0, void 0, function () {
        var raydiumSwap, tokenBalance, tokenSolBalance, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getTokenBalance(raydiumSwap, config_1.CONFIG.BASE_MINT)];
                case 2:
                    tokenSolBalance = _a.sent();
                    console.log("Balance of token ".concat(config_1.CONFIG.QUOTE_MINT, ": ").concat(tokenBalance));
                    console.log("Balance of Sol token ".concat(config_1.CONFIG.BASE_MINT, ": ").concat(tokenSolBalance));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
