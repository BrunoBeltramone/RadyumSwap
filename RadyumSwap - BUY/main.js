...
function swap() {
    return __awaiter(this, void 0, void 0, function () {
        var raydiumSwap, poolInfo, _a, priorityFee, swapTx, simulationResult, error_1, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    _a = raydiumSwap.findPoolInfoForTokens(config_1.CONFIG.BASE_MINT, config_1.CONFIG.QUOTE_MINT);
                    if (_a) return [3 /*break*/, 3];
                    return [4 /*yield*/, raydiumSwap.findRaydiumPoolInfo(config_1.CONFIG.BASE_MINT, config_1.CONFIG.QUOTE_MINT)];
                case 2:
                    _a = (_b.sent());
                    _b.label = 3;
                case 3:
                ...
                case 5:
                    ...
                    return [4 /*yield*/, raydiumSwap.getSwapTransaction(config_1.CONFIG.QUOTE_MINT, config_1.CONFIG.TOKEN_A_AMOUNT, poolInfo, config_1.CONFIG.USE_VERSIONED_TRANSACTION, config_1.CONFIG.SLIPPAGE)];
                case 6:
                    swapTx = _b.sent();
                    ...
                    console.log("Swapping ".concat(config_1.CONFIG.TOKEN_A_AMOUNT, " SOL for BONK"));
